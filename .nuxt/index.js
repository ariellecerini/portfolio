...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"acerinidesigns","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"X-UA-Compatible","content":"IE=edge"},{"name":"viewport","content":"width=device-width, initial-scale=1.0, maximum-scale=1.5, user-scalable=1, shrink-to-fit=no"},{"hid":"description","name":"description","content":undefined},{"name":"author","content":"Arielle Cerini"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (process.client && typeof nuxt_plugin_googleAnalytics_728a9100 === 'function') {
    await nuxt_plugin_googleAnalytics_728a9100(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_stickyHeader_2f1703aa === 'function') {
    await nuxt_plugin_stickyHeader_2f1703aa(app.context, inject)
  }
