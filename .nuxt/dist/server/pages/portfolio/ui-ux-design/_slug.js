...
module.exports.__inject__ = function (context) {
  add("23821820", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_a7d1834a_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(116);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_a7d1834a_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_a7d1834a_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_a7d1834a_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_a7d1834a_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".full-width-background[data-v-a7d1834a]{margin:auto}.not-full-width[data-v-a7d1834a]{margin:auto;max-width:1300px}.phoneHolder iframe[data-v-a7d1834a]{height:650px;margin:auto}.desktop-holder iframe[data-v-a7d1834a]{border:2px solid #e6e6e6;border-radius:12px}.design-system iframe[data-v-a7d1834a],.desktop-holder iframe[data-v-a7d1834a]{height:650px;width:100%}.design-system[data-v-a7d1834a]{margin-bottom:24px}.design-system[data-v-a7d1834a],.phoneHolder[data-v-a7d1834a]{background:#f4f4f4;text-align:center}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/portfolio/ui-ux-design/_slug.vue?vue&type=template&id=a7d1834a&scoped=true
var render = function render() {
  ...
  }, [_vm._ssrNode("<section class=\"row not-full-width\" data-v-a7d1834a>", "</section>", [_vm._ssrNode("<div class=\"col-xs-12 col-sm-12 col-md-8 col-lg-8\" data-v-a7d1834a>", "</div>", [_c('project-title', {
    attrs: {
  ...
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row col-no-gutter margin-top-base\" data-v-a7d1834a>", "</div>", [_vm._ssrNode("<div class=\"col-xs-6 col-sm-6 col-md-6 col-lg-6 col-no-gutter\" data-v-a7d1834a>", "</div>", [_c('project-timeframe', {
    attrs: {
      "timeframeStart": `${_vm.post.attributes.dateStart}`,
      "timeframeEnd": `${_vm.post.attributes.dateEnd}`
    }
  })], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xs-6 col-sm-6 col-md-6 col-lg-6 col-no-gutter\" data-v-a7d1834a>", "</div>", [_c('NuxtLink', {
    attrs: {
  ...
  })], 1)], 1)], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xs-12 col-sm-12 col-md-4 col-lg-4 padding-top-s\" data-v-a7d1834a>", "</div>", [_c('project-button', {
    attrs: {
      "buttonHref": `${_vm.post.attributes.link}`,
      "buttonText": `${_vm.post.attributes.linkText}`,
      "buttonTitle": `${_vm.post.attributes.linkTitle}`
    }
  })], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" data-v-a7d1834a>", "</div>", [_vm._ssrNode("<div class=\"col-xs-12 col-s-12 col-md-8 col-lg-8 col-no-gutter\" data-v-a7d1834a>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-a7d1834a>", "</div>", [_vm._ssrNode("<div class=\"col-xs-12 col-s-12 col-md-4 col-lg-4\" data-v-a7d1834a>", "</div>", [_c('project-details', {
    attrs: {
      "title": "Position",
      "details": `${_vm.post.attributes.position}`
    }
  })], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xs-12 col-s-12 col-md-4 col-lg-4\" data-v-a7d1834a>", "</div>", [_c('project-details', {
    attrs: {
      "title": "Role",
  ...
  })], 1)], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xs-12 col-s-12 col-md-4 col-lg-4\" data-v-a7d1834a>", "</div>", [_c('project-description', {
    attrs: {
      "description": `${_vm.post.attributes.description}`
    }
  })], 1)], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<section class=\"section-primary-05 full-width-background\" style=\"background: url('../../section-primary-05.svg'); background-position: 0 0; background-size: 40% auto;  background-repeat: no-repeat;\" data-v-a7d1834a>", "</section>", [_vm._ssrNode("<div class=\"not-full-width row\" data-v-a7d1834a>", "</div>", [_vm._ssrNode("<div class=\"container page-content featured-image\" data-v-a7d1834a><img" + _vm._ssrAttr("src", _vm.post.attributes.featuredImage) + " data-v-a7d1834a></div> <hr data-v-a7d1834a> "), _vm._l(_vm.cModules, function (cModule) {
    return _vm._ssrNode("<div" + _vm._ssrAttr("cModule", cModule) + _vm._ssrClass("container page-content", `${cModule.class}`) + _vm._ssrStyle(null, `${cModule.style}`, null) + " data-v-a7d1834a>", "</div>", [_vm._ssrNode("<h2 data-v-a7d1834a>" + _vm._ssrEscape(" " + _vm._s(cModule.header) + " ") + "</h2> " + (`${cModule.item}` == 'image' ? "<div data-v-a7d1834a><img" + _vm._ssrAttr("src", `${cModule.image}`) + " style=\"width:100%;\" data-v-a7d1834a></div>" : "<!---->") + " " + (`${cModule.item}` == 'text' ? "<div style=\"margin-top: auto; margin-bottom: auto;\" data-v-a7d1834a>" + _vm._ssrList(cModule.inner, function (content) {
      return "<div" + _vm._ssrAttr("content", content) + " data-v-a7d1834a><p" + _vm._ssrClass(null, content.class) + _vm._ssrStyle(null, content.style, null) + " data-v-a7d1834a>" + _vm._ssrEscape(_vm._s(content.text)) + "</p></div>";
    }) + "</div>" : "<!---->") + " "), `${cModule.item}` == 'button' ? _vm._ssrNode("<div data-v-a7d1834a>", "</div>", _vm._l(cModule.inner, function (content) {
      return _vm._ssrNode("<div" + _vm._ssrAttr("content", content) + " style=\"width: 100%; padding:0;\" data-v-a7d1834a>", "</div>", [_c('button-link', {
        attrs: {
          "href": `${content.src}`,
          "text": `${content.text}`
        }
      })], 1);
    }), 0) : _vm._e(), _vm._ssrNode(" " + (`${cModule.item}` == 'iframe' ? "<div SameSite=\"Strict\" data-v-a7d1834a>" + _vm._ssrList(cModule.inner, function (content) {
      return "<div" + _vm._ssrAttr("content", content) + _vm._ssrClass(null, cModule.class) + " style=\"margin: auto; width: 100%;\" data-v-a7d1834a><iframe" + _vm._ssrAttr("src", content) + " frameborder=\"0\" allowfullscreen=\"allowfullscreen\"" + _vm._ssrStyle({
        "padding-top": "0"
      }, content.style, null) + " data-v-a7d1834a></iframe></div>";
    }) + "</div>" : "<!---->") + " " + (`${cModule.item}` == 'pdf-grid' ? "<div data-v-a7d1834a>" + _vm._ssrList(cModule.inner.contents, function (content) {
      return "<div" + _vm._ssrAttr("content", content) + " data-v-a7d1834a><div class=\"row\" data-v-a7d1834a>" + _vm._ssrList(content.images, function (image) {
        return "<div" + _vm._ssrAttr("image", image) + _vm._ssrClass(null, content.col) + " data-v-a7d1834a><a" + _vm._ssrAttr("href", image) + " data-v-a7d1834a><embed" + _vm._ssrAttr("src", image) + " type=\"application/pdf\" class=\"document-pdf\" style=\"padding-top: 0; padding-bottom: 0;\" data-v-a7d1834a></a></div>";
      }) + "</div></div>";
    }) + "</div>" : "<!---->"))], 2);
  })], 2)])], 2);
};
...
// CONCATENATED MODULE: ./pages/portfolio/ui-ux-design/_slug.vue?vue&type=template&id=a7d1834a&scoped=true
