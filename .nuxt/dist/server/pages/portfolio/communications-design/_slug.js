exports.ids = [26,8,9,11,13,14,15,17,18,19];
exports.modules = {
...
module.exports.__inject__ = function (context) {
  add("4c5cb73a", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_3dd632b2_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(114);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_3dd632b2_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_3dd632b2_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_3dd632b2_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_slug_vue_vue_type_style_index_0_id_3dd632b2_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".full-width-background[data-v-3dd632b2]{margin:auto}.not-full-width[data-v-3dd632b2]{margin:auto;max-width:1300px}.phoneHolder iframe[data-v-3dd632b2]{height:650px;margin:auto}.design-system iframe[data-v-3dd632b2]{height:650px;width:100%}.card-mockup img[data-v-3dd632b2]{box-shadow:0 15px 35px rgba(50,50,93,.1),0 5px 15px rgba(0,0,0,.07)}.design-system[data-v-3dd632b2]{margin-bottom:24px}.design-system[data-v-3dd632b2],.phoneHolder[data-v-3dd632b2]{background:#f4f4f4;text-align:center}", ""]);
// Exports
...
var render = function render() {
  ...
  }, [_vm._ssrNode("<section class=\"row not-full-width\" data-v-3dd632b2>", "</section>", [_vm._ssrNode("<div class=\"col-xs-12 col-sm-12 col-md-8 col-lg-8\" data-v-3dd632b2>", "</div>", [_c('project-title', {
    attrs: {
  ...
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row col-no-gutter margin-top-base\" data-v-3dd632b2>", "</div>", [_vm._ssrNode("<div class=\"col-xs-6 col-sm-6 col-md-6 col-lg-6 col-no-gutter\" data-v-3dd632b2>", "</div>", [_c('project-timeframe', {
    attrs: {
      "timeframeStart": `${_vm.post.attributes.dateStart}`,
      "timeframeEnd": `${_vm.post.attributes.dateEnd}`
    }
  })], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xs-6 col-sm-6 col-md-6 col-lg-6 col-no-gutter\" data-v-3dd632b2>", "</div>", [_c('NuxtLink', {
    attrs: {
  ...
  })], 1)], 1)], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" data-v-3dd632b2>", "</div>", [_vm._ssrNode("<div class=\"col-xs-12 col-s-12 col-md-6 col-lg-6 col-no-gutter\" data-v-3dd632b2>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-3dd632b2>", "</div>", [_vm._ssrNode("<div class=\"col-xs-12 col-s-12 col-md-6 col-lg-6\" data-v-3dd632b2>", "</div>", [_c('project-details', {
    attrs: {
      "title": "Role",
      "details": `${_vm.post.attributes.role}`
    }
  })], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xs-12 col-s-12 col-md-6 col-lg-6\" data-v-3dd632b2>", "</div>", [_c('project-details', {
    attrs: {
      "title": "Tools & Technology",
      "details": `${_vm.post.attributes.tools}`
    }
  })], 1)], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xs-12 col-s-12 col-md-6 col-lg-6\" data-v-3dd632b2>", "</div>", [_c('project-description', {
    attrs: {
      "description": `${_vm.post.attributes.description}`
    }
  })], 1)], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<section class=\"section-primary-05 full-width-background\" style=\"padding-top:48px; background: url('../../section-primary-05.svg'); background-position: 0 0; background-size: 40% auto;  background-repeat: no-repeat;\" data-v-3dd632b2>", "</section>", [_vm._ssrNode("<div class=\"not-full-width row\" data-v-3dd632b2>", "</div>", [_vm._ssrNode("<div class=\"container page-content featured-image\" data-v-3dd632b2><img" + _vm._ssrAttr("src", _vm.post.attributes.featuredImage) + " data-v-3dd632b2></div> <hr data-v-3dd632b2> "), _vm._l(_vm.cModules, function (cModule) {
    return _vm._ssrNode("<div" + _vm._ssrAttr("cModule", cModule) + _vm._ssrClass("container page-content", `${cModule.class}`) + _vm._ssrStyle(null, `${cModule.style}`, null) + " data-v-3dd632b2>", "</div>", [_vm._ssrNode("<h2 data-v-3dd632b2>" + _vm._ssrEscape(" " + _vm._s(cModule.header) + " ") + "</h2> " + (`${cModule.item}` == 'image' ? "<div data-v-3dd632b2><img" + _vm._ssrAttr("src", `${cModule.image}`) + " style=\"width:100%;\" data-v-3dd632b2></div>" : "<!---->") + " " + (`${cModule.item}` == 'text' ? "<div style=\"margin-top: auto; margin-bottom: auto;\" data-v-3dd632b2>" + _vm._ssrList(cModule.inner, function (content) {
      return "<div" + _vm._ssrAttr("content", content) + " data-v-3dd632b2><p" + _vm._ssrStyle(null, content.style, null) + " data-v-3dd632b2>" + _vm._ssrEscape(_vm._s(content.text)) + "</p></div>";
    }) + "</div>" : "<!---->") + " "), `${cModule.item}` == 'button' ? _vm._ssrNode("<div data-v-3dd632b2>", "</div>", _vm._l(cModule.inner, function (content) {
      return _vm._ssrNode("<div" + _vm._ssrAttr("content", content) + " style=\"width: 100%; padding:0;\" data-v-3dd632b2>", "</div>", [_c('button-link', {
        attrs: {
          "href": `${content.src}`,
          "text": `${content.text}`
        }
      })], 1);
    }), 0) : _vm._e(), _vm._ssrNode(" " + (`${cModule.item}` == 'iframe' ? "<div SameSite=\"Strict\" data-v-3dd632b2>" + _vm._ssrList(cModule.inner, function (content) {
      return "<div" + _vm._ssrAttr("content", content) + _vm._ssrClass(null, cModule.class) + " style=\"margin: auto; width: 100%;\" data-v-3dd632b2><iframe" + _vm._ssrAttr("src", content) + " frameborder=\"0\" allowfullscreen=\"allowfullscreen\"" + _vm._ssrStyle({
        "padding-top": "0"
      }, content.style, null) + " data-v-3dd632b2></iframe></div>";
    }) + "</div>" : "<!---->") + " " + (`${cModule.item}` == 'pdf-grid' ? "<div data-v-3dd632b2>" + _vm._ssrList(cModule.inner.contents, function (content) {
      return "<div" + _vm._ssrAttr("content", content) + " data-v-3dd632b2><div class=\"row\" data-v-3dd632b2>" + _vm._ssrList(content.images, function (image) {
        return "<div" + _vm._ssrAttr("image", image) + _vm._ssrClass(null, content.col) + " data-v-3dd632b2><a" + _vm._ssrAttr("href", image) + " data-v-3dd632b2><embed" + _vm._ssrAttr("src", image) + " type=\"application/pdf\" class=\"document-pdf\" style=\"padding-top: 0; padding-bottom: 0;\" data-v-3dd632b2></a></div>";
      }) + "</div></div>";
    }) + "</div>" : "<!---->"))], 2);
  })], 2)])], 2);
};
...
// CONCATENATED MODULE: ./pages/portfolio/communications-design/_slug.vue?vue&type=template&id=3dd632b2&scoped=true
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/portfolio/communications-design/_slug.vue?vue&type=script&lang=js
...
// CONCATENATED MODULE: ./pages/portfolio/communications-design/_slug.vue?vue&type=script&lang=js
 /* harmony default export */ var communications_design_slugvue_type_script_lang_js = (_slugvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/portfolio/communications-design/_slug.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  communications_design_slugvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  injectStyles,
