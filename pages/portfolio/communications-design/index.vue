<template>
  ...
  <div class="category-page" style="width: inherit">
    <section class="row not-full-width  padding-bottom-base padding-top-md" id="section_page-title" > 
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><h1>Communications Design</h1></div>
    </section> 
  ...
  props: ['slug'],
    async asyncData() {
      ...
      const imports = resolve
        ...
        .filter((post) => post.attributes.category == 'communications-design')
      return {
        posts: imports
      }
    }, 
